...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Crear cadenas de fecha y hora combinadas
    ...
    if ($result->num_rows > 0) {
        // Nombre del archivo
        $filename = "datos_filtrados_" . date('Ymd') . ".csv";
        ...
        // Escribir la primera línea (encabezados) en el archivo CSV
        fputcsv($output, array('Temperatura (°C)', 'Fecha', 'Hora'));
                    ...
                    <div class="row row-bordered g-0">
                        ...
                        <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                            ...
                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <br><br>
                                <input type="submit" value="Filtrar y Exportar">
                            </form>
                            <?php
                            if ($message) {
