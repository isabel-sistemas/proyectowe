            ...
            fill: black;
                                            ...
                                            <svg width="500%" height="150%">
                                                ...
                                                if (!empty($temperaturas) && !empty($fechas)) {
                                                    ...
                                                    // Eje X
                                                    echo "<line x1='0' y1='$graph_height' x2='$graph_width' y2='$graph_height' class='axis' />";
                                                    foreach ($fechas as $index => $fecha) {
                                                        $x = $index * $x_step;
                                                        echo "<text x='$x' y='" . ($graph_height + 15) . "' class='label' transform='rotate(45 $x," . ($graph_height + 15) . ")'>$fecha</text>";
                                                    }

                                                    // Eje Y
                                                    echo "<line x1='0' y1='0' x2='0' y2='$graph_height' class='axis' />";
                                                    for ($i = 0; $i <= 5; $i++) {
                                                        $temp_label = $min_temp + ($i * $temp_range / 5);
                                                        $y = $graph_height - ($i * $graph_height / 5);
                                                        echo "<text x='-30' y='$y' class='label'>" . round($temp_label, 1) . "°C</text>";
                                                    }
                                                }
                                                ?>
                                            </svg>
